...
<span class="cite-hidden">{% cite Nauta2023_cvpr_pipne %}</span>
<span class="cite-hidden">{% cite Nauta2021_cvpr_prototree %}</span>
<span class="cite-hidden">{% cite Nauta2023_csur_evaluating-xai-survey %}</span>
<span class="cite-hidden">{% cite Nauta2023_xml_pipnet-medical %}</span>
