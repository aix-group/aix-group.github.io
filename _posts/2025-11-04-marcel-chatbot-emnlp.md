---
title: "Student Chatbot (EMNLP'25)"
...
At this year’s **EMNLP in Suzhou, China**, Jan Trienes presented *Marcel*—a **RAG-based conversational agent** built to handle enrollment questions at Marburg University. The project grew out of a simple observation: as our **M.Sc. Data Science program** expanded, so did the repetitive workload for staff answering student inquiries about deadlines, prerequisites, and language requirements. So, we set up a [project]({% post_url 2024-04-01-marflex-marcel-project %}).
...
<i class="fa fa-book-reader" style="font-size:12px;color: #7a46eb;"></i> {% reference Trienes2025_emnlp_marcel-chatbot %} [PDF](https://aclanthology.org/2025.emnlp-demos.13.pdf) 

<i class="fa-brands fa-github" style="font-size:12px;color: #7a46eb;"></i>  [Source Code](https://github.com/aix-group/marcel-chat)
